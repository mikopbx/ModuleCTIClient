 ...
 */
    ...
    'mod_cti_Server1CHostPort' => 'Адреса та порт сервера 1С',
    ...
    'mod_cti_AuthApp_Name' => 'Реєстрація зовнішньої панелі',
    'mod_cti_AuthApp_Description' => 'Дозволяє прив\'язати панель до SIP обліку за цифровим кодом',
    'mod_cti_EnableDebugMode' => 'Включити режим налагодження модуля та логування всіх подій',
    'mod_cti_AutoSettingsData' => 'Дані для автоматичного налаштування',
    'mod_cti_Connected' => 'Модуль працює коректно',
    'mod_cti_Disconnected' => 'Відключений',
    'mod_cti_ConnectionProgress' => 'Запускаються послуги модуля',
    'mod_cti_ConnectionError' => 'Помилка роботи модуля',
    'mod_cti_ConnectionTo1CError' => 'Не вдалося підключитися до вебсервісу 1С',
    'mod_cti_UpdateStatus' => 'Оновлення статусу',
    'mod_cti_ConnectionWait' => 'Очікуємо підключення до MikoPBX з боку 1С',
    'mod_cti_tab_Settings' => 'Налаштування',
    'mod_cti_CrmGroupHeader' => 'Інтеграція з CRM',
    'mod_cti_CrmSelectHeader' => 'Виберіть CRM',
    'mod_cti_GroupOther' => 'Інші налаштування',
